...
export default async function NotFound() {
  return (
    <div className={style["not-found-page-wrapper"]}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
        ...
        <g id="Layer_12 yellow-back-fig" data-name="Layer 12">
          ...
          <g id="round-conf">
            <path
              className={[style["cls-1"], style["circle"], style["c1"]].join(
                " "
              )}
            ...
            />
            <path
              className={[style["cls-1"], style["circle"], style["c2"]].join(
                " "
              )}
            ...
            />
            <path
              className={[style["cls-1"], style["circle"], style["c3"]].join(
                " "
              )}
            ...
            />
            <path
              className={[style["cls-1"], style["circle"], style["c4"]].join(
                " "
              )}
            ...
            />
            <path
              className={[style["cls-1"], style["circle"], style["c5"]].join(
                " "
              )}
            ...
            />
            <path
              className={[style["cls-1"], style["circle"], style["c6"]].join(
                " "
              )}
        ...
        <g id="fortyfour" data-name="Layer 2">
          <g className={[style["four"], style["a"]].join(" ")}>
            <rect
          ...
          <g className={[style["four"], style["b"]].join(" ")}>
            <rect
              className={style["cls-2"]}
              x="1558.84"
              y="391.91"
        ...
        <g id={style["umbrella"]} data-name="Layer 3">
          <g>
            <circle
        ...
        <g id={style["pillow"]} data-name="Layer 4">
          <path
            className={style["cls-1"]}
        ...
        <g id={style["cup"]} data-name="Layer 7">
          <polygon
            className={style["cls-1"]}
        ...
        <g id="clock" data-name="Layer 8">
          ...
          <rect
            className={[style["cls-3"], style["clock-hand-1"]].join(" ")}
            x="845"
            y="189.5"
            width="6.04"
            height="58"
          ...
          />
          <rect
            className={[style["cls-3"], style["clock-hand-2"]].join(" ")}
            x="845"
            y="209.5"
            width="6.04"
            height="38"
        ...
        <g id={style["rucksack"]} data-name="Layer 6">
          <g id={style["stripe"]}>
            <path
        ...
        <g id={style["bike"]} data-name="Layer 5">
          <path
            className={[style["cls-8"], style["wheel"]].join(" ")}
